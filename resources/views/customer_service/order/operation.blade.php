  ...
  border-radius: 50%;
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div class="col-md-12">
                        <h2> {{ __('models/translator.determine_order_operation') }} </h2>
                    </div>
                                ...
                                <table id="orders" class="table table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> {{ __('models/translator.operation_name') }} </th>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference28">
                                                      ...
                                                      <a class="dropdown-item update_price" data-old_price="{{$order->order->total_amount}}"  data-order_id={{$order->order->id}} href="#">{{ __('models/translator.update_price') }}</a>
...
alert(order_id);
request = $.ajax({
        url: '{{route('customer_service.operation.update_price')}}',
        type: "post",
        data: {
