  ...
  border-radius: 50%;
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div class="col-md-12">
                        <h2> {{ __('models/translator.special_service') }} </h2>
                    </div>
                                ...
                                <table id="orders" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           @if($order->total_amount) <td>{{ $order->total_amount }}</td> @else   <td>{{ __('models/translator.price_not_determine') }}</td>    @endif
                                            <td>{{ $order->date }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference28">
                                                        <a class="dropdown-item show"  data-download_order="{{$order->id}}"   href="#">{{ __('models/translator.download_order') }}</a> 
                                                    
                                                      {{-- <a class="dropdown-item accept_order" data-accept_order={{$order->id}} href="#">{{ __('models/translator.accept_order') }}</a> --}}
                                                      <a class="dropdown-item update_price"   data-order_id={{$order->id}} href="#">{{ __('models/translator.update_price') }}</a>
