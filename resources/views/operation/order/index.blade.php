  ...
  border-radius: 50%;
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div class="col-md-12">
                        <h2>{{ __('models/translator.order_new') }} </h2>
                    </div>
                                ...
                                <table id="orders" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ __('models/translator.order.n') }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference28">
                                                      ...
                                                      <a class="dropdown-item" href="{{ Route('operation.chat',['user_id' => $order->user_id,'order_id'=>$order->id]) }}">{{ __('models/translator.chat') }}</a> 
  ...
  <script>
    ...
    swal({
      ...
      if (result.value) {
        ...
        request = $.ajax({
        url: '{{route('operation.order.accept')}}',
        type: "post",
        data: {
            'order_id':order_id,
        }
