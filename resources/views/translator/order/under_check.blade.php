  ...
  border-radius: 50%;
            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    <div class="col-md-12">
                        <h2> {{ __('models/translator.under_check') }} </h2>
                    </div>
                                ...
                                <table id="orders" class="table table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> {{ __('models/translator.comment') }} </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ __('models/translator.order.uc') }}</td>
                                            <td>{{ $order->order->total_amount }}</td>
                                            <td>{{ $order->order->date }}</td>
                                            <td>  
                                                  
                                             
                                          </div>   <button class="btn btn-dark mb-2 mr-2 rounded-circle show_comment" data-comment="{{$order->comment}}"> <i data-feather="eye"></i><span class="icon-name"> </span></button>     </td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference28">
                                                        <a class="dropdown-item show_trans"  data-download_order="{{$order->order->id}}"   href="#">{{ __('models/translator.download_order') }}</a> 
                                                    
                                                      {{-- <a class="dropdown-item accept_order" data-accept_order={{$order->id}} href="#">{{ __('models/translator.accept_order') }}</a> --}}
                                                      <a class="dropdown-item upload_translations"  data-order_id={{$order->id}} href="#">{{ __('models/translator.re_submit_translate') }}</a>
                          ...
                          <div class="modal-body">
                              <div class="form-group mb-4">
                                ...
                                <div class="custom-file-container" data-upload-id="myFirstImage">
                                  <label>{{ __('models/translator.trans_file') }} <a href="javascript:void(0)" style="color: red" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                                  <label class="custom-file-container__custom-file" >

                                      <input required type="file" name="file" id="trans_file" class="custom-file-container__custom-file__custom-file-input" accept="/*">
            ...
            <div class="modal fade" id="CommentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalCenterTitle">{{ __('models/translator.show_comment') }}</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                          </button>
                      </div>
                      <div class="modal-body">
                          <div class="form-group mb-4">
                            <input hidden name="order_id" id="order_id" >
                              <label for="exampleFormControlTextarea1">{{ __('models/translator.show_comment') }}</label>
                              <textarea id="comment" name="comment" disabled required class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                          </div>
                      </div>
                      <div class="modal-footer">
...
@section('page_scripts')
  ...
  <script>
    ...
    $(".show_comment").click(function(event){
           ...
           if(comment =='')
           {
             comment='{{ __('models/translator.no_comment') }}'
           }
            
           $('#comment').val(comment);
           $('#CommentModal').modal('show');
    });
    $(".show_trans").click(function(event){
